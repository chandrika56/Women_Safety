...
import static xyz.himanshu.womensafety.MyLocationListener.latitude;
import static xyz.himanshu.womensafety.MyLocationListener.longitude;
...
//btnsend
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b= (Button) findViewById (R.id.email);
        ...
        b.setOnClickListener (new View.OnClickListener ( ) {
            ...
            public void onClick(View view) {
                ...
                it.putExtra(Intent.EXTRA_SUBJECT,"Danger");
                it.putExtra(Intent.EXTRA_TEXT,"Need Your help I am in danger.\n My location is:"+ finalMessage1);
                it.setType("message/rfc822");
                startActivity(Intent.createChooser(it,"Choose Mail App"));
            }
        });

        final MediaPlayer catSoundMediaPlayer = MediaPlayer.create(this, R.raw.police);

        final Button playCatMeow = (Button) this.findViewById(R.id.sound);
        ...
        final Button playCatMeo = (Button) this.findViewById(R.id.button2);
        playCatMeo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
